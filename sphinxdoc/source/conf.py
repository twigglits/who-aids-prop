...
# -*- coding: utf-8 -*-
#
# Simpact Cyan documentation build configuration file, created by
...
def getVersion():
    ...
    for l in open(os.path.join(curDir,"../../CMakeLists.txt")):
        pref = "set(VERSION "
...
htmlhelp_basename = 'simpactcyandoc'
...
latex_documents = [
    (master_doc, 'simpactcyandoc.tex', 'Simpact Cyan Documentation',
     'Hasselt University', 'manual'),
]
...
man_pages = [
    (master_doc, 'simpactcyandoc', 'Simpact Cyan Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'simpactcyandoc', 'Simpact Cyan Documentation',
     author, 'simpactcyandoc', 'One line description of project.',
     'Miscellaneous'),
]
