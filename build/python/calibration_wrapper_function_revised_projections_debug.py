def calibration_wrapper_function(parameters = None):
    ...
    prep_intro2 = {
            ...
            "EventPrep.threshold":0.95, #0.965, #0.87, # threshold for willingness to start prep. coverage is 13%
            'EventPrepDrop.threshold': 0.001#0.8
        }
    
    prep_intro3 = {
            "time":43, #around  2023
            "EventPrep.threshold":0.88, #0.965, #0.87, # threshold for willingness to start prep. coverage is 13%
            'EventPrepDrop.threshold': 0.001#0.8
        }
...
#     }
    ...
    cab_intro_opt = {
            ...
            "EventCAB.enabled":"true",
            "EventCAB.threshold": 0.95, #optimistic with 4400 users by 2030
            "EventPrep.threshold":0.90, #scale down oral prep 
            "EventCABDROP.enabled":"true",
            "EventCABDROP.threshold": 0.3
    }
...
#     # prep+cab+dvr
    dvr_intro = {
            ...
            "EventDVR.threshold": 0.9,
            "EventDVRDROP.enabled":"true",
            "EventDVRDROP.threshold": 0.05
    }
    
    dvr_intro_1 = {
            "time":47.1, #around 2024
            "EventDVR.threshold": 0.8
    }
#     dvr_intro = {
...
#         }
    ...
    # Debug_baseline = [hiv_testing, conception,
    ...
    # Debug_cab_scenario = [hiv_testing, conception,
    #                art_intro, art_intro1, art_intro2, art_intro2_2, art_intro3, art_intro4, art_intro5,
    #               condom_intro1, condom_intro2, condom_intro3, vmmc_intro1,vmmc_intro2,
    #                      cab_intro, cab_intro_1]
    
#     Debug_oral_prep_scenario = [hiv_testing, conception,
#                    art_intro, art_intro1, art_intro2, art_intro2_2, art_intro3, art_intro4, art_intro5,
#                   condom_intro1, condom_intro2, condom_intro3, vmmc_intro1,vmmc_intro2,
#                   prep_intro1, prep_intro2, prep_intro3]
    
#     Debug_oral_prep_cab_scenario = [hiv_testing, conception,
#                    art_intro, art_intro1, art_intro2, art_intro2_2, art_intro3, art_intro4, art_intro5,
#                   condom_intro1, condom_intro2, condom_intro3, vmmc_intro1,vmmc_intro2,
#                   prep_intro1, prep_intro2, prep_intro3, cab_intro_opt, cab_intro_opt_1]

    Debug_dvr_scenario = [hiv_testing, conception,
                   art_intro, art_intro1, art_intro2, art_intro2_2, art_intro3, art_intro4, art_intro5,
                  condom_intro1, condom_intro2, condom_intro3, vmmc_intro1,vmmc_intro2,
                         dvr_intro, dvr_intro_1]
    
    # Debug_oral_prep_cab_dvr_scenario = [hiv_testing, conception,
    #                art_intro, art_intro1, art_intro2, art_intro2_2, art_intro3, art_intro4, art_intro5,
    #               condom_intro1, condom_intro2, condom_intro3, vmmc_intro1,vmmc_intro2,
    #               prep_intro1, prep_intro2, prep_intro3, dvr_intro, dvr_intro_1]
    
#     Debug_AGYW_condom = [hiv_testing, conception,
#                    art_intro, art_intro1, art_intro2, art_intro2_2, art_intro3, art_intro4, art_intro5,
#                   condom_intro1, condom_intro2, condom_intro3, vmmc_intro1,vmmc_intro2,
#                         agyw_condom_intro]
    
#     Debug_AGYW_diagnosis = [hiv_testing, conception,
#                    art_intro, art_intro1, art_intro2, art_intro2_2, art_intro3, art_intro4, art_intro5,
#                   condom_intro1, condom_intro2, condom_intro3, vmmc_intro1,vmmc_intro2,
#                            agyw_diagosis_halfway_2030]
    
#     Debug_AGYW_condom_diagnosis = [hiv_testing, conception,
#                    art_intro, art_intro1, art_intro2, art_intro2_2, art_intro3, art_intro4, art_intro5,
#                   condom_intro1, condom_intro2, condom_intro3, vmmc_intro1,vmmc_intro2,
#                   agyw_condom_intro, agyw_diagosis_halfway_2030]
    
    # Debug_all_diagnosis = [hiv_testing, conception,art_intro, art_intro1, art_intro2, 
    #                            art_intro2_2, art_intro3, art_intro4, art_intro5,
    #                            condom_intro1, condom_intro2, condom_intro3, vmmc_intro1,vmmc_intro2,
    #                            diagnosis_intro]
    
    Debug_vmmc = [hiv_testing, conception,art_intro, art_intro1, art_intro2, 
                               art_intro2_2, art_intro3, art_intro4, art_intro5,
                               condom_intro1, condom_intro2, condom_intro3, vmmc_intro1,vmmc_intro2,
                               vmmc_intro3]
...
#                      dvr_intro_opt, dvr_intro_opt_1, agyw_diagosis_optimistic_2030]
    ...
    results = simpact.run(
        config=cfg_list,
        destDir=destDir,
        interventionConfig=Debug_dvr_scenario,
        seed=seedid,
    ...
    file_path = f'Calibration/final_data/datalist_debug_dvr_scenario_{identifier}.pkl'
