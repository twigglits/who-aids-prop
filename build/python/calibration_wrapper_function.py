def calibration_wrapper_function(parameters = None):
    ...
    # cfg["monitoring.fraction.log_viralload"] = 0.6
    art_intro = {
        "time": 18, #around 2003
        ...
        "hivtransmission.param.a": parameters['hivtransmission_param_a'] + 0.5,
        "formation.hazard.simple.alpha_0": parameters['formation_hazard_simple_alpha_0']+0.07
    }
    ...
    art_intro1 = {
        ...
        "hivtransmission.param.a": parameters['hivtransmission_param_a'] + 1
    }
    ...
    art_intro3 = {
        ...
        "formation.hazard.simple.alpha_0": parameters['formation_hazard_simple_alpha_0']+0.15
    }
...
#                             (45, 50), (45, 50)]:
        ...
        ART_cov_eval_timepoints = np.array([25.5, 30.5, 35.5, 38.5,50])  # Using np.arange to generate timepoints
