...
prior = pyabc.Distribution(hivtransmission_param_f1=pyabc.RV("uniform", 2.5, 1),
                           hivtransmission_param_a=pyabc.RV("uniform", -2.5, 0.35),
                           formation_hazard_agegapry_gap_agescale_man=pyabc.RV("uniform", 0, 0.08),
                           formation_hazard_agegapry_gap_agescale_woman=pyabc.RV("uniform", 0, 0.1),
                           ...
                           person_eagerness_man_dist_gamma_b=pyabc.RV("uniform", 30, 20),
                           person_eagerness_woman_dist_gamma_b=pyabc.RV("uniform", 30, 20),
                           formation_hazard_agegapry_gap_factor_man_woman_exp=pyabc.RV("uniform", -1.8, 1),
                           formation_hazard_agegapry_baseline=pyabc.RV("uniform", 1.3, 1.5),
                           ...
                           conception_alpha_base=pyabc.RV("uniform", -3, 0.25),
                           conception_alpha_base_1=pyabc.RV("uniform", 0.25, 0.2),
                           ...
                           diagnosis_baseline_t2=pyabc.RV("uniform", 0.05, 0.1),
