...
macro(add_simpact_executable_or_library LIBOREXE EXEPREFIX MAINSOURCES)
	...
	if (UNIX AND NOT CMAKE_GENERATOR STREQUAL Xcode)
		...
		set_target_properties(${EXEPREFIX}-opt PROPERTIES COMPILE_DEFINITIONS "TIFFVERSION=${TIFF_VERSION_MAJOR};${OPENMPDEFINE}")
		...
		set_target_properties(${EXEPREFIX}-opt-debug PROPERTIES COMPILE_DEFINITIONS "TIFFVERSION=${TIFF_VERSION_MAJOR};${OPENMPDEFINE}")
		...
		set_target_properties(${EXEPREFIX}-basic-debug PROPERTIES COMPILE_DEFINITIONS "TIFFVERSION=${TIFF_VERSION_MAJOR};SIMPLEMNRM;${OPENMPDEFINE}")
