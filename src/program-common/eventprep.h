...
public:
	...
	static double s_prepAGYWIncrement;

private:
	bool isEligibleForTreatmentP1(double t, const State *pState, Person *pPerson);
	bool isWillingToStartTreatmentP1(double t, GslRandomNumberGenerator *pRndGen, Person *pPerson);
